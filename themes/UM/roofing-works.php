...
<main>
	<div id="rent-banner"
		class="main-banner rent-banner services-page-banner construction-services-banner roofing-works-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Кровельные работы</h1>
				<div class="main-banner__text">Кровельные работы – это этап обустройства верхнего элемента строения
					подверженного атмосферным осадкам. Основная функция кровли – защита помещений внутри здания от
					дождя, снега и других сюрпризов погоды. Основные требования, предъявляемые к конструкции:
					минимальный вес, большой срок службы и надежность. Работы могут проводиться во время строительства
					дома или капремонта.</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img
					...
					class="catalog__location-current">Кровельные работы</span></div>
		...
		<div class="container">
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Устройство кровли из рулонных материалов и мастики</div>
					<div class="info__text">
						<p>Рулонная крыша – это направленный или плоский вариант кровли. В её обустройстве применим
							рубероид, пергамин, толь, полимерная пленка. Также могут наноситься мастичные материалы
							непосредственно на бетонную основу.</p>
						<p>Кровельные работы Минск в ООО «УМ-2020» проводятся по четкому плану:</p>
					</div>
					<ul class="info__list">
						<li>Обустраивается укрепляющая стяжка из бетонной смеси. Её наносят прямо на железобетонные
							плиты перекрытия.</li>
						<li>Укладывается слой пароизоляции. Могут использоваться как материалы в рулонах, так и мастика.
						</li>
						<li>Создаётся гидроизоляционный слой. Для этого полосы материала укладывают внахлест с
							перекрытием 10-15 см.</li>
						<li>Обустраивается дренажная основа. Используется сыпучий материал, хорошо впитывающий влагу,
							такой как керамзит.</li>
						<li>Укладывается слой теплоизоляции. Утеплитель может быть плитным, монолитным или сыпучим.</li>
						<li>Укладывается слой геотекстиля. Для заполнения используется песок или гравий.</li>
						<li>Выравнивается стяжка. Она бывает из асфальтобетона или цементной смеси.</li>
						<li>Укладывается финишный слой. Применяются материалы в рулонах или наносится слой мастики в
							качестве финишного покрытия.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-25.webp">
					<div class="info__text">Чтобы кровля прослужила много лет без протечек, и других проблем лучше
						работы доверить профессионалам компании ООО «УМ-2020».</div>
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-26.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Особенности листового и штучного материала</div>
					<div class="info__text">
						<p>Под штучным стройматериалом для кровли подразумевают керамическую, мягкую или металлическую
							черепицу. Листовой вид кровли обустраивается из ондулина, профнастила или шифера.</p>
						<p>Обустройство кровли подразумевает следующие этапы:</p>
					</div>
					<ul class="info__list">
						<li>Установку мауэрлата – несущего бруса для опоры стропильных ног.</li>
						<li>Монтаж стропильной конструкции. Она составляет основу кровли и формирует основные скаты.
						</li>
						<li>Укладку пароизоляционной мембраны. Её фиксируют с нижней стороны стропил.</li>
						<li>Укладку утеплителя. Используется материал в рулонах или матах.</li>
						<li>Монтаж финишного покрытия. Кровельные работы завершаются укладкой сплошного настила
							устойчивого к осадкам.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-26.webp">
					<div class="info__text">Для грамотного проведения монтажных и ремонтных кровельных работ важно
						четкое знание особенностей укладки разных материалов. Поэтому весь процесс лучше доверить
						профессиональным кровельщикам.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Кровли из мелкоштучных материалов</div>
					<div class="info__text">Мелкоштучные материалы используются при перекрытии кровли жилых зданий,
						таких как коттеджи, вилы, дачи и загородные дома. При этом уклон крыши может составлять до 85°.
						Обычно используют:</div>
					<ul class="info__list">
						<li>асбестоцементную плитку;</li>
						<li>битумно-полимерную плитку;</li>
						<li>черепицу из глины или смеси цемента с песком.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-27.webp">
					<div class="info__text">Заказывая услуги кровельные работы в ООО «УМ-2020» клиент может забыть о
						постоянном контроле рабочих процессов. У нас только профессиональные кровельщики с большим
						опытом в строительной сфере.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-28.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Кровли из асбестовых и цементно-волокнистых листов</div>
					<div class="info__text">
						<p>Асбестовые и цементно-волокнистые листы популярны благодаря хорошим эксплуатационным
							характеристикам и доступной цене. Они широко применяются в обустройстве кровли объектов
							жилого, производственного и сельскохозяйственного фонда Республики Беларусь.</p>
						<p>Асбестовые и цементно-волокнистые листы бывают:</p>
					</div>
					<ul class="info__list">
						<li>Волновыми обыкновенными. Это классический прямоугольный шифер.</li>
						<li>Волновыми усиленными. Используются для перекрытия промышленных объектов.</li>
						<li>Волновыми унифицированными. Это шифер с шестью волнами.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-28.webp">
					<div class="info__text">Цена на услуги профессионалов рассчитывается персонально для каждого проекта
						исходя из поставленных задач. Но в любом случае она будет наиболее выгодной в ООО «УМ-2020», так
						как у нас есть необходимые материалы, техника и оборудование для обеспечения полного цикла
						работ.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Устройство кровли из листовой стали</div>
					<div class="info__text">Кровельные работы цена которых зависит от выбранного листового материала
						могут выполняться из:</div>
					<ul class="info__list">
						<li>Профнастила. Сравнительно недорогой вариант, применяемый для перекрытия разных жилых и
							нежилых построек.</li>
						<li>Металлочерепицы. Лёгкий прочный материал простой в монтаже, напоминающий черепицу из глины.
						</li>
						<li>Фальцевой кровли. Листы из оцинкованного металла, для соединения которых используется
							фальцы.</li>
					</ul>
					<div class="info__text">Для монтажа листовой оцинкованной стали наши специалисты выполняют:</div>
					<ul class="info__list">
						<li>Подготовку материала к установке. Листовая сталь осматривается на наличие повреждений
							защитного покрытия.</li>
						<li>Разметку листов. Кровельный материал размечают по нужным размерам.</li>
						<li>Установку костылей по периметру карнизного свеса. Они поддерживают обшивочные листы.</li>
						<li>Монтаж металлических листов. Соседние элементы соединяются фальцевым швом и крепятся
							кляммерами к обрешётке.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-29.webp">
					<div class="info__text">Установка кровельных стальных листов требует осторожности из-за возможности
						повреждения защитного слоя. Профессионалы ООО «УМ-2020» гарантируют не только качественные
						кровельные работы Минск, а и помощь с другими сопутствующими вопросами.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
	...
	<div class="info construction-services-info">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Кровельные работы «под ключ»</div>
				<div class="info__text">Мы нацелены на продуктивное сотрудничество со всеми клиентами. Нами предлагаются
					услуги по обустройству кровли любых объектов под ключ. Наши специалисты качественно и в сроки,
					указанные в договоре, выполнят следующие работы:</div>
				<ul class="info__list">
					<li>Демонтируют старый кровельный материал. Данный этап предусмотрен в случае с капремонтом или
						работами по реконструкции крыши. На начальном этапе определяются задачи и объем предстоящих
						мероприятий. Учитываются элементы пригодные к ремонту и подлежащие замене.</li>
					<li>Установят стропильный каркас и обрешётку. Расценки последней зависят от выбранной конструкции,
						которая может быть односкатной, двускатной или плоской. Также учитываются сложные детали
						архитектуры.</li>
					<li>Смонтируют водосток и парапет. Правильно установленная система отвода дождевой воды увеличивает
						срок службы дома.</li>
					<li>Уложат кровельный сэндвич. Обустраивается паровая и гидроизоляция, укладывается утеплитель. В
						скатной крыше дополнительно предусмотрена вентиляция для отвода лишней влаги.</li>
					<li>Уложат финишный кровельный слой. Учитываются тип кровли, особенности климата конкретного региона
						Беларуси, архитектурная и эстетическая составляющая строения. Не на последнем месте бюджет,
						предусмотренный для ремонтных работ.</li>
				</ul>
				<div class="info__text">Решив заказать кровельные работы в ООО «УМ-2020» клиент может связаться с нашими
					консультантами по телефону, с помощью формы обратной связи или лично посетив наш офис по адресу,
