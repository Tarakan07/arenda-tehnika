...
<main>
  <div id="rent-banner" class="main-banner rent-banner">
    <div class="container">
      <div class="main-banner__left">
        <h1 class="main-banner__title">Аренда спецтехники</h1>
        <div class="main-banner__text">Аренда спецтехники является популярной услугой в условиях современного
          технического прогресса и индустриализации общества. Техника специального назначения все больше применяется во
          всех областях жизнедеятельности человека, начиная от частного строительства до разработки крупных
          месторождений.</div>
      </div>
      ...
      <div class="main-banner__social">
        <ul>
          <li><a href="#">
            <svg class="main-banner__inst" width="40" height="40" viewBox="0 0 40 40" fill="none"
          ...
          <li><a href="#">
            <svg class="main-banner__whatsapp" width="40" height="40" viewBox="0 0 40 40" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
                  ...
                  fill="#FFCA40" /></svg></a></li>
          <li><a href="#">
            <svg class="main-banner__telegram" width="40" height="40" viewBox="0 0 40 40" fill="none"
                xmlns="http://www.w3.org/2000/svg">
                <path fill-rule="evenodd" clip-rule="evenodd"
  ...
  <div class="catalog">
    <div class="container">
      <div class="catalog__location"><a class="catalog__location-history" href="#">Главная</a> <img alt="loc-arrow"
          ...
          class="catalog__location-current">Аренда спецтехники</span></div>
        <?php if ( function_exists( 'dimox_breadcrumbs' ) ) dimox_breadcrumbs(); ?>
      <div class="catalog__title">Каталог спецтехники</div>
      <div class="catalog__top">
        <div class="catalog__search-group"><input type="text" placeholder="Поиск спецтехники"> <button
        ...
        <div class="catalog__sort-wrap">
          <div class="center"><select name="sources" id="sources" class="custom-select sources"
              ...
              <option value="profile">популярности</option>
              <option value="word">возрастанию цены</option>
              <option value="hashtag">убыванию цены</option>
            </select></div>
      ...
      <div class="catalog__content">
        <div class="catalog__aside">
          <nav class="catalog__navigation">
            <ul>
              <li><a>
                  <div class="catalog__item-wrap"><span>Экскаваторы</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
                  <li><a href="#">Колесный экскаватор</a></li>
                  <li><a href="#">Гусеничный экскаватор</a></li>
                  <li><a href="#">Экскаватор-погрузчик</a></li>
                  <li><a href="#">Экскаватор-планировщик</a></li>
                  <li><a href="#">Цепной экскаватор</a></li>
                </ul>
              </li>
              <li><a>
                  <div class="catalog__item-wrap"><span>Погрузчики</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Бульдозеры</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Самосвалы</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Автокраны</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Гидромолоты</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Буровая техника</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Автогрейдеры</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Грунтовые катки</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Тралы и низкорамные площадки</span></div><svg width="7"
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Автовышки</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Автобетононасосы</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Гидроманипуляторы</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
              ...
              <li><a>
                  <div class="catalog__item-wrap"><span>Мини-техника</span></div><svg width="7" height="12"
                    viewBox="0 0 7 12" fill="none" xmlns="http://www.w3.org/2000/svg">
                    <path d="M1 1L6 6L1 11" stroke="#202022" /></svg>
                </a>
                <ul class="catalog__subitems">
        ...
        <div class="catalog__items"><?php echo do_shortcode('[um-products]') ?></div>
      </div>
      <div class="catalog__pagination">
        <div class="catalog__pagination-items">
          <div class="catalog__pagination-item current-page">1</div>
          <div class="catalog__pagination-item">2</div>
          <div class="catalog__pagination-item">3</div>
          <div class="catalog__pagination-item">4</div>
          <div class="catalog__pagination-item">5</div>
          <div class="catalog__pagination-item">6</div>
          <div class="catalog__pagination-item">7</div>
          <div class="catalog__pagination-item">8</div>
        </div><a class="catalog__pagination-next" href="#"><span>Далее</span> <img alt="pagination-arrow"
            src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-right.svg"></a>
      </div>
    </div>
  </div>
  ...
  <div class="categories">
    <div class="container">
      <div class="posts__top">
        <div class="categories__title">Виды спецтехники</div><a class="posts__link mobile-box" href="#">Посмотреть
          все<img alt="link-arrow" src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-2.svg"></a>
      </div>
      <div class="categories__items"><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category1.png">
            <div class="category__name-wrap">
              <div class="category__name">Экскаваторы</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category2.png">
            <div class="category__name-wrap">
              <div class="category__name">Погрузчики</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category3.png">
            <div class="category__name-wrap">
              <div class="category__name">Бульдозеры</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category4.png">
            <div class="category__name-wrap">
              <div class="category__name">Самосвалы</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category5.png">
            <div class="category__name-wrap">
              <div class="category__name">Строительные краны</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category6.png">
            <div class="category__name-wrap">
              <div class="category__name">Гидромолоты</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category7.png">
            <div class="category__name-wrap">
              <div class="category__name">Буровая техника</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category8.png">
            <div class="category__name-wrap">
              <div class="category__name">Автогрейдер</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category9.png">
            <div class="category__name-wrap">
              <div class="category__name">Грунтовой каток</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category10.png">
            <div class="category__name-wrap">
              <div class="category__name">Тралы и низкорамные площадки</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category11.png">
            <div class="category__name-wrap">
              <div class="category__name">Автовышки</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category12.png">
            <div class="category__name-wrap">
              <div class="category__name">Автобетононасосы</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category13.png">
            <div class="category__name-wrap">
              <div class="category__name">Гидроманипуляторы</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category14.png">
            <div class="category__name-wrap">
              <div class="category__name">Мини-техника</div>
            </div>
          </div>
        </a><a href="#">
          <div class="categories__item"><img alt="category-img"
              src="<?php echo get_template_directory_uri(); ?>/assets/images/category15.png">
            <div class="category__name-wrap">
              <div class="category__name">Услуги спецтехники</div>
            </div>
          </div>
        </a><a class="categories__mob-link" href="#">Посмотреть все<img alt="link-arrow"
            src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-2.svg"></a></div>
    </div>
  </div>
    ...
    <div class="container">
      <div class="conditions__top">
        <div class="conditions__text">
          ...
          <p>В связи с широкой областью применения, востребованной становиться аренда строительной техники, техники
            погрузочной или горнодобывающей – любых машин, способных заменить человеческий труд, повысить качество и
            скорость работ.</p>
          <p>Услуги аренды спецтехники выгодны тем, что не связаны с большими денежными затратами: компании получают
            ...
            src="<?php echo get_template_directory_uri(); ?>/assets/images/klipartz.png">
        ...
        <div class="conditions__right">
          <p>В зависимости от сферы применения спецтехника, взятая в аренду в ООО «УМ-2020» отличается по техническим
            характеристикам, габаритам и внешнему виду. Любая спецтехника спроектирована для конкретного рода работ,
            поэтому при выборе важна их классификация.</p><img class="conditions__image" alt="excavator"
            src="<?php echo get_template_directory_uri(); ?>/assets/images/klipartz.png">
        </div>
  ...
  <div class="varieties">
    <div class="container">
      <div class="varieties__title">Разновидности спецтехники</div>
      <div class="varieties__text">Аренда спецтехники используется для большинства специфических работ и при любых
        условиях: под водой, в космосе, при рытье траншей или разработке карьеров и т.д. и имеет много разновидностей,
        что объясняется широкой областью её применения. Все машины можно разделить на три вида:</div>
      <ul class="varieties__list">
        <li><span>Землеройные.</span> Техника, используются при земельных работах;</li>
        <li><span>Погрузочная.</span> Осуществляют задачи по погрузке-разгрузке материала;</li>
        <li><span>Транспортировочная.</span> Перемещение и доставка груза.</li>
      </ul>
      <div class="varieties__subtitle">Более подробная классификация спецтехники зависит от следующих показателей:</div>
      ...
      <div class="varieties__text">Вид арендованной спецтехники, цена и сроки проката зависят от производимых работ и их
    ...
    <div class="container">
      <div class="feedback__content">
        ...
        <div class="feedback__right"><img alt="feedback-img" class="feedback__img"
            src="<?php echo get_template_directory_uri(); ?>/assets/images/feedback-img.png">
  ...
  <div class="info">
    <div class="container">
      ...
      <div class="info__right">
        <div class="info__title">Область применения</div>
    ...
    <div class="container">
      ...
      <div class="advantages__items"><a class="advantages__item" href="/">
          ...
          <div class="advantages__item-text">Отсутствие затрат на приобретение, ремонт, обслуживание, хранение и
            ...
            src="<?php echo get_template_directory_uri(); ?>/assets/images/advantages2.png">
          ...
          <div class="advantages__item-text">Быстрое оформление договора;</div><img class="advantages__img_4"
            alt="advantages-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/advantages4.png">
        </a><a class="advantages__item" href="/">
          ...
          <div class="advantages__item-text">Помощь в выборе машины;</div><img class="advantages__img_1"
            alt="advantages-img" src="<?php echo get_template_directory_uri(); ?>/assets/images/advantages1.png">
        </a><a class="advantages__item" href="/">
          ...
          <div class="advantages__item-text">Использование исправной, готовой к работе технике без дополнительной
            ...
            src="<?php echo get_template_directory_uri(); ?>/assets/images/advantages5.png">
        </a>
        <div class="advantages__text-item">
          <p>Аренда строительной техники экономит время фирмы-заказчика и позволяет производить более качественные
  ...
  <div class="posts">
    <div class="container">
      <div class="posts__top">
        <div class="posts__title">Интересное</div><a class="posts__link" href="#">Посмотреть все<img alt="link-arrow"
            src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-2.svg"></a>
      </div>
      <div id="posts-slider" class="posts__items owl-carousel owl-theme"><?php echo do_shortcode( '[um-posts]' ); ?>
      </div>
  ...
  <div class="reviews">
    <div class="container">
      <div class="reviews__top">
        <div class="reviews__title">Отзывы</div><a class="posts__link" href="#">Посмотреть все<img alt="link-arrow"
            src="<?php echo get_template_directory_uri(); ?>/assets/images/arrow-2.svg"></a>
      </div>
      <div id="reviews-slider" class="reviews__items owl-carousel owl-theme">
        <?php echo do_shortcode( '[um-reviews]' ); ?></div>
