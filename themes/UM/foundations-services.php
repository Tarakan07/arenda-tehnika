 ...
 * @package sss
 * 
 * Template Name: Foundations services
 */
...
<main>
	<div id="rent-banner"
		class="main-banner rent-banner services-page-banner construction-services-banner foundations-services-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Услуги по возведению оснований</h1>
				<div class="main-banner__text">Услуги по возведению оснований в Республике Беларусь необходимы при
					строительстве любого здания для обеспечения надежности и устойчивости объекта на протяжении всего
					срока службы. Качественно созданный фундамент способен прослужить полтора века. Обустройство
					основания — это сложная процедура, требующая соответствующей подготовки, для изучения геологических
					особенностей участка влияющих на итоговое качество работ.</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img
					...
					class="catalog__location-current">Услуги по возведению оснований</span></div>
...
?>
	...
	<div class="services-page-items construction-services-banners-items">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Устройство искусственных оснований</div>
				<div class="info__text">
					<p>Возведение основания здания требует качественной подготовки строительной площадки. Особо проблема
						актуальна для набухающей и водонасыщенной глинистой почвы, залегающей на глубине.</p>
					<p>Искусственное основание позволяет снизить глубину осадки фундамента строения. Его создание может
						обеспечиваться одним из трех способов:</p>
				</div>
				<ul class="info__list">
					<li>уплотнением грунта, механизированными устройствами;</li>
					<li>полной или частичной заменой почвы на строительном участке;</li>
					<li>закреплением грунта физико-химическим воздействием.</li>
				</ul>
				<div class="info__text">На показатели прочности и устойчивости строения сильно влияет правильность
					выбора основания и конструкция фундамента. Поэтому подготовительные работы лучше доверить
					профессионалам ООО «УМ-2020».</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Земляные работы</div>
					<div class="info__text">
						<p>Даже проведя геологические пробы грунта нельзя гарантировать что, возведение основания для
							строительства жилого дома пройдёт без сюрпризов. Только после старта рытья котлована можно
							выяснить особенности залегания грунтовой воды, качество почвы и другие характеристики.</p>
						<p>Для надёжного создания фундамента ленточного типа дополнительно обустраивается первоначальная
							гравийная подушка. Это в разы увеличивает эксплуатационный ресурс слоя гидроизоляции для
							предотвращения вероятности проседания каркаса из арматуры при заливке бетонной смеси.</p>
						<p>Земляные работы подразумевают два основных этапа:</p>
					</div>
					<ul class="info__list">
						<li>устройство траншеи с помощью экскаватора или вручную;</li>
						<li>засыпку гравия для уплотнения и формирования подушки.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-30.webp">
					<div class="info__text">Благодаря комплексному подходу к работам мы гарантируем долговечность
						здания, возведенного на прочном фундаменте.</div>
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-31.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Арматурные работы</div>
					<div class="info__text">
						<p>Благодаря применению стальной арматуры можно значительно укрепить бетонную конструкцию.
							Стоимость закупки материала для армирования бетона является существенной составляющей
							итоговой цены фундамента. Рекомендуется использование до 10 м стальных прутов диаметром 12
							мм на каждый квадратный метр бетона.</p><img class="service-page__image-mobile"
							alt="service-img"
							src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-31.webp">
						<p>Возведение основания для строительства жилого дома требует четкого соблюдения всех
							технологических процессов. Чтобы обеспечить максимальный срок службы строения, лучше
							доверить все работы профессионалам ООО «УМ-2020».</p>
					</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title services-short-title">Опалубочные работы</div>
					<div class="info__text">
						<p>Для сооружения опалубки обычно используются деревянные доски, которые усиливаются
							множественными брусками, упирающимися в грунт или колышки. Также могут применяться стяжки из
							металла или проволоки и шпильки внутри в пластиковых трубах.</p><img
							class="service-page__image-mobile" alt="service-img"
							src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-32.webp">
						<p>Установка опалубки — это ответственный процесс из-за того, что жидкая бетонная смесь создает
							большую нагрузку в особенности с высоким и широким фундаментом. Зачастую неопытные строители
							допускают и ошибки, из-за которых жидкий бетон просачивается в грунт. Во избежание подобных
							ситуаций лучше работы доверить сотрудникам ООО «УМ-2020».</p>
					</div>
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-33.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Бетонные работы</div>
					<div class="info__text">
						<p>Основная задача при заливке жидкой смеси получить монолитную конструкцию, для достижения
							которой раствор должен заливаться в опалубку за один заход. Добиться этого с помощью
							бетономешалки или замешивания раствор вручную невозможно. Поэтому мы доставляем цементный
							состав в специальных миксерах.</p>
						<p>Чтобы основание было качественным и прочным нами учитываются следующие нюансы:</p>
					</div>
					<ul class="info__list">
						<li>Периодичность подачи очередного бетоновоза не должна быть более 2 часов.</li>
						<li>Заливка осуществляется слоями с разравниванием цементной смеси по периметру опалубки.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-33.webp">
					<div class="info__text">Для снижения воздействия на основание здания внешних факторов,
						обустраивается вертикальная и горизонтальная гидроизоляция, а также утепляется отмостка для
						уменьшения глубины промерзания грунта.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
		</div>
	...
	<div class="info construction-services-info">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Преимущества сотрудничества с ООО «УМ-2020»</div>
				<div class="info__text">
					<p>Для экономии собственных сил, средств и времени лучше обратиться для обустройства фундамента к
						профессионалам ООО «УМ-2020». Это гарантирует высокое качество проведения фундаментных работ с
						учётом установленных требований и стандартов.</p>
					<p>Сотрудничество с нами подразумевает для клиентов следующие преимущества:</p>
				</div>
				<ul class="info__list">
					<li>Оперативные услуги по возведению оснований.</li>
					<li>Заключение официального договора с фиксацией стоимости и других условий сотрудничества.</li>
					<li>Использование качественной арматуры и бетонной смеси.</li>
					<li>Актуальные расценки на профессиональные услуги в соответствии с ситуацией на рынке.</li>
					<li>Выполнение всех работ в сроки, установленные договором.</li>
				</ul>
				<div class="info__text">Для того чтобы заказать услуги по возведению оснований, достаточно связаться с
					нашими менеджерами по телефонам, указанным на сайте, написать на электронную почту или оставить
					онлайн-заявку. Мы гарантируем, что все работы будут выполнены качественно, быстро и в соответствии с
					требованиями необходимыми клиенту, чтобы здание, построенное на фундаменте, прослужило максимально
					долго.</div>
			</div>
		</div>
	</div>
