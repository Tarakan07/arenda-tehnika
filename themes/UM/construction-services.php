	...
	<div id="rent-banner" class="main-banner rent-banner services-page-banner construction-services-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Строительные услуги</h1>
				<div class="main-banner__text">Оказание строительных услуг необходимо для реализации проектов жилого и нежилого
					фонда. Они включают возведение зданий, их внешнюю и внутреннюю реконструкцию, модернизацию, отделку и другие
					сопутствующие работы. Это довольно обширная сфера, состоящая из десятков разных мероприятий.</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img alt="loc-arrow"
					...
					class="catalog__location-current">Строительные услуги</span></div>
		...
		<div class="container">
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Снос, демонтаж зданий и сооружений</div>
					<div class="info__text">
						<p><a href="/snos-demontazh-zdanij-i-sooruzhenij">Демонтаж разных строений</a> является ключевой услугой в
							строительной сфере. В Республике Беларусь всегда найдутся здания, находящиеся в аварийном состоянии,
							которые нужно снести, чтобы на их месте построить новый объект.</p>
						<p>Снос в ООО «УМ-2020» проходит по определенному плану:</p>
					</div>
					<ul class="info__list">
						<li>Оказание строительных услуг по демонтажу, начинается с анализа состояния объекта и строений,
							расположенных рядом.</li>
						<li>Подготавливается территория, удаляются ценные предметы, и обеспечивается безопасность.</li>
						<li>Демонтируется отделка, инженерные системы и коммуникации.</li>
						<li>Разбирается несущая конструкция и вывозится строительный мусор.</li>
					</ul>
					<div class="info__text">У нас доступен как частичный, так и полный демонтаж зданий в зависимости от планов и
						предпочтений клиента.</div><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-1.webp">
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-2.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Подготовительные работы к строительству</div>
					<div class="info__text">Комплекс подготовительных внутриплощадочных и внеплощадочных работ состоит из:</div>
					<ul class="info__list">
						<li>прокладки подъездных дорог к строительной площадке;</li>
						<li>установки предупреждающих знаков о ведении строительства;</li>
						<li>планировки стройплощадки под возведение здания;</li>
						<li>расчистки территории от зелёных насаждений;</li>
						<li>удаления плодородных слоев грунта;</li>
						<li>уплотнения рыхлой почвы;</li>
						<li>отключения и разборки коммуникационных систем;</li>
						<li>установки временных построек для хранения оборудования.</li>
					</ul>
					<div class="info__text">Все виды подготовительных мероприятий проводятся в соответствии с установленными
						требованиями и нормативами. Предварительно получаются необходимые разрешения и документы.</div><img
			...
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Земляные работы</div>
					<div class="info__text">Основную часть <a href="/zemljanye-raboty">земляных работ</a> можно поделить на
						открытого, подводного и подземного типов. Два последних варианта требуют привлечения спецтехники. Опытные
						сотрудники ООО «УМ-2020»:</div>
					<ul class="info__list">
						<li>подготовят основание под заливку фундамента;</li>
						<li>выкопают вручную или <a href="/arenda-jekskavatorov">экскаватором</a> траншею необходимых параметров;
						</li>
						<li>уплотнят грунт для обеспечения устойчивости здания;</li>
						<li>выкопают колодец под коммуникационные и инженерные системы;</li>
						<li>разровняют рельеф строительной площадки.</li>
					</ul>
					<div class="info__text">Мы выполняем комплекс земляных работ в Минске и других городах Республики Беларусь. Мы
						способны оказать строительные услуги любой сложности благодаря собственному автопарку и штату опытных
						сотрудников.</div><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-3.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-4.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Заливка фундамента и возведение оснований</div>
					<div class="info__text">
						<p>Качественное основание жилого или нежилого здания является залогом его долговечности. Для его сооружения
							требуется ответственный подход с применением надежных стройматериалов, привлечением профильных
							специалистов и соблюдением проверенных технологий.</p>
						<p><a href="/uslugi-po-zalivke-fundamenta">Для возведения фундамента</a> под объектом наши профессионалы:
						</p>
					</div>
					<ul class="info__list">
						<li>разрабатывают технический проект;</li>
						<li>подготавливают строительную площадку;</li>
						<li>проводят комплекс земляных работ;</li>
						<li>устанавливают опалубку;</li>
						<li>выполняют армирование;</li>
						<li>заливают бетонный состав;</li>
						<li>проводят обратную засыпку грунта.</li>
					</ul>
					<div class="info__text">ООО «УМ-2020» гарантирует, что строительство фундамента или сооружение основания
						пройдёт успешно как в летний, так и в зимний сезон. Это стало возможным благодаря нашему опыту и наличию
						необходимого оборудования.</div><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-4.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Монтажные работы</div>
					<div class="info__text">Услуги строительных работ, связанные <a href="/uslugi-montazhnyh-rabot">с
							монтажом</a>, подразумевают разноплановые механизированные операции для создания основы перед проведением
						строительства. В комплекс входит установка каркасных элементов строения, железобетонных, металлических и
						деревянных конструкций. Учитывая сложность всего процесса, его лучше доверить профессионалам ООО «УМ-2020».
					</div><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-5.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-6.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Отделочные работы</div>
					<div class="info__text">ООО «УМ-2020» предоставляет разные строительные услуги, в том числе <a
							href="/otdelochnye-raboty">внутреннюю и наружную отделку жилых и нежилых помещений.</a> Наши маляры,
						штукатуры и другие профильные сотрудники выполнят:</div>
					<ul class="info__list">
						<li><a href="/shtukaturnye-raboty">шпаклёвку и оштукатуривание стен и потолка;</a></li>
						<li><a href="/maljarnye-raboty">окраску поверхностей любых размеров;</a></li>
						<li>оклейку обоев в помещениях;</li>
						<li>установку гипсокартонных конструкций;</li>
						<li>выравнивание пола;</li>
						<li>укладку декоративных напольных покрытий;</li>
						<li>нанесение финишных покрытий на стены и потолок;</li>
						<li>облицовку поверхностей плиткой.</li>
					</ul>
					<div class="info__text">Все отделочные работы проводятся с применением стройматериалов, выбранных заказчиком.
						Декорирование происходит в соответствии с дизайнерским проектом. Это помогает сократить и упростить отделку.
					</div><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-6.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
			...
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Кровельные работы</div>
					<div class="info__text">Нами выполняется комплекс работ, <a href="/krovelnye-raboty">начиная от
							первоначального возведения крыши и заканчивая настилом финишного покрытия.</a> Наши кровельщики:</div>
					<ul class="info__list">
						<li>подготовят проект кровли;</li>
						<li>установят стропильную конструкцию;</li>
						<li>соберут обрешётку:</li>
						<li>утеплят крышу;</li>
						<li>подошьют свесы;</li>
						<li>установят водостоки</li>
					</ul>
					<div class="info__text">Работами занимаются кровельщики с опытом обустройства конструкций разных типов. Они
						обеспечат быстрое выполнение заказа в соответствии с условиями и требованиями клиента.</div><img
						class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-7.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-8.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Благоустройство и озеленение территорий</div>
					<div class="info__text">Облагораживая территорию, наши ландшафтные дизайнеры и другие узкопрофильные
						сотрудники:</div>
					<ul class="info__list">
						<li>уложат тротуарную плитку и другие покрытия;</li>
						<li>проведут озеленение, высадят клумбы и организуют зелёный газон;</li>
						<li>установят игровые площадки, скамейки, беседки, навесы;</li>
						<li>разместят декоративные элементы;</li>
						<li>уберут и вывезут мусор, оставшийся после работы.</li>
					</ul>
					<div class="info__text">Под благоустройством придомовой территории подразумевается оказание работ, отвечающие
						за эстетический вид участка вокруг строительного объекта жилого или нежилого фонда. Эксперты и дизайнеры ООО
						«УМ-2020» предложат клиентам несколько проектов и воплотят их в жизни. Благодаря этому двор частного дома
						или территория вокруг офисного центра будет удобной и привлекательной.</div><img
						class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-8.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
			...
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Ремонт зданий и сооружений</div>
					<div class="info__text">Мы готовы оказать строительные услуги в Минске при выполнении текущих и капитальных
						ремонтных работ. <a href="/remont-zdanij-i-sooruzhenij">Ремонт зданий и сооружений</a> у нас — это:</div>
					<ul class="info__list">
						<li>комплекс работ по укреплению и ремонту основания строения;</li>
						<li>устранение следов износа настенных, напольных и других поверхностей;</li>
						<li>усиление межкомнатных перегородок;</li>
						<li>восстановление крыши и других перекрытий;</li>
						<li>ремонт системы обеспечения помещения теплом;</li>
						<li>модернизация коммуникаций.</li>
					</ul>
					<div class="info__text">Каждый проект в соответствии с поставленными задачами разрабатывается персонально
						после согласования с клиентом. Для расчета итоговой цены подготавливается технический план предстоящих
						работ.</div><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-9.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
	...
	<div class="info construction-services-info">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Почему стоит обращаться в ООО «УМ-2020»</div>
				<div class="info__text">Благодаря опыту работы на строительном рынке Республики Беларусь мы способны реализовать
					проект любой сложности. Все мероприятия проводятся профессиональными мастерами с использованием качественных
					стройматериалов и проверенных технологий. Чтобы заказать оказание строительных услуг, достаточно набрать номер
					телефона, указанный на сайте или оставить заявку онлайн.</div>
