...
<main>
    <div class="main-banner rent-banner services-page-banner">
        <div class="container">
            <div class="main-banner__left">
                <h1 class="main-banner__title">Услуги спецтехники</h1>
                <div class="main-banner__text">Оказание услуг спецтехники в Минске пользуется популярностью. И этому
                    есть вполне логичное объяснение. Содержать большой автопарк транспорта, который используется
                    периодически нерентабельно с финансовой точки зрения. Намного выгоднее арендовать трактор,
                    экскаватор или погрузчик, чем тратиться на их покупку.</div>
            </div>
    ...
    <div class="conditions services-page-conditions">
        <div class="container">
            <div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img
                    ...
                    class="catalog__location-history" href="/arenda-spectehniki">Аренда спецтехники</a> <img
                    alt="loc-arrow" src="<?php echo get_template_directory_uri(); ?>/assets/images/loc-arrow.svg"> <span
                    class="catalog__location-current">Услуги спецтехники</span></div>
            <div class="conditions__top">
                <div class="conditions__text">
                    <div class="conditions__title">Популярные услуги</div>
                    <p>Обычно в автопарке любой компании содержится спецтехника для регулярного использования. Чтобы
                        реализовать узкопрофильные задачи, намного выгоднее заказать услуги на короткий или длительный
                        срок вместе с оператором. Это помогает сэкономить как на приобретении дорогого оборудования, так
                        и на зарплате дополнительной единицы в штате. Также отпадают вопросы по хранению, обслуживанию и
                        ремонту самоходных машин.</p><img class="conditions__image_mobile" alt="tractor"
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/tractor.webp">
                    <p>Обращаться в компанию ООО «УМ-2020» выгодно если нужно:</p>
                    <ul class="info__list">
                        <li>пробурить отверстие в твердом материале;</li>
                        <li>вывезти и утилизировать грунт;</li>
                        <li>купить строительный песок;</li>
                        <li>перевезти негабаритные грузы;</li>
                        <li>убрать и вывезти снег.</li>
                    </ul>
                    <p>В соответствии с потребностями клиентов мы предоставляем спецтехнику на любой срок для разовых
                        или многократных работ. Мы занимаемся техническим сопровождением и обслуживанием машин. По
                        желанию клиента может предоставляться опытный оператор.</p>
                </div><img class="conditions__image" alt="tractor"
                    src="<?php echo get_template_directory_uri(); ?>/assets/images/tractor.webp">
            </div>
        </div>
    </div>
    ...
    <div class="categories services-page-categories">
	<?php theme_sidebar( 'left' ); ?>
    <div class="services-page-items">
        <div class="container">
            <div class="services-page__item">
                <div class="services-page__info">
                    <div class="info__title">Бурение отверстий в твердых материалах</div>
                    <div class="info__text">
                        <p>Бурение отверстий позволяет в минимальные сроки проделать проём в сооружении. Такая услуга
                            популярна в быту и на крупных строительных проектах. Это инновационная технология,
                            позволяющая сверлить бетонные перекрытия практически любой толщины.</p>
                        <p>Используя уникальную технологию бурения, наши специалисты смогут:</p>
                        <ul class="info__list">
                            <li>пробурить бетон и железобетон;</li>
                            <li>просверлить отверстия в натуральных материалах: камне и граните;</li>
                            <li>изготовить проем в стене, потолке и любой другой перегородке;</li>
                            <li>просверлить технологическое отверстие под трубопровод в фундаменте;</li>
                            <li>пробурить асфальтобетонное покрытие любой толщины.</li>
                        </ul><img class="service-page__image-mobile" alt="service-img"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item1.webp">
                        <p>Бурение с помощью специального оборудования позволяет создавать отверстия в прочном
                            искусственном или натуральном материале. Такую услугу часто заказывают в случаях, когда
                            стандартный перфоратор со сверлами с твердосплавными наконечниками не справляется с
                            поставленными задачами.</p>
                    </div>
            ...
            <div class="services-page__item">
                <div class="services-page__image">
                    <div class="helper"></div><img alt="service-img"
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item2.webp">
                </div>
                <div class="services-page__info">
                    <div class="info__title">Вывоз и утилизация грунта</div>
                    <div class="info__text">
                        <p>Утилизацию грунта ошибочно считают простым процессом. В реальности это комплекс работ по
                            переработке, захоронению или повторному использованию излишков почвы, образовавшейся после
                            проведения земельных работ. Просто вывезти остатки почвы за пределы населенного пункта
                            нельзя. Это грозит штрафными санкциями.</p><img class="service-page__image-mobile"
                            alt="service-img"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item2.webp">
                        <p>Чтобы вывезти и утилизировать грунт потребуются услуги спецтехники, которая есть в наличии
                            нашего автопарка. Мы возьмем на себя все заботы по погрузке и вывозу остатков земли после
                            земляных работ или предоставим специализированную технику в аренду.</p>
                    </div>
                    <div class="info__call-button">Подробнее</div>
                </div>
            </div>
            <div class="services-page__item">
                <div class="services-page__info">
                    <div class="info__title">Продажа строительного песка</div>
                    <div class="info__text">
                        <p>Универсальным строительным материалом, применяемым в разных сферах, является песок. Часто его
                            приобретают компании, производящие бетон и железобетонные изделия. Хотя встречаются и
                            нетипичные ситуации, когда нужно немного песка, чтобы наполнить песочницу.</p>
                        <p>Компания ООО «УМ-2020» предлагает в Минске песок в любом объеме для любых нужд. Мы готовы
                            обеспечить строительный объект или частного заказчика:</p>
                        <ul class="info__list">
                            <li>песком сеяным;</li>
                            <li>песком мытым;</li>
                            <li>песком штукатурным;</li>
                            <li>песком кварцевым.</li>
                        </ul><img class="service-page__image-mobile" alt="service-img"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item3.webp">
                        <p>Мы обеспечиваем погрузку, разгрузку и доставку песка по Минску и области, используя
                            спецтехнику собственного автопарка. Если возникнут вопросы по поводу сотрудничества,
                            стоимости или объёма сыпучего материала всегда можно связаться с нашими менеджерами по
                            телефону.</p>
                    </div>
                    <div class="info__call-button">Подробнее</div>
                </div>
            ...
            <div class="services-page__item">
                <div class="services-page__image">
                    <div class="helper"></div><img alt="service-img"
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item4.webp">
                </div>
                <div class="services-page__info">
                    <div class="info__title">Вывоз строительного мусора</div>
                    <div class="info__text">
                        <p>На любой строительной площадке в процессе работ скапливается много мусора. Поэтому его вывоз
                            — это популярная услуга в Беларуси. После демонтажа, перепланировки комнат, установки окон и
                            дверей на строительном объекте скапливается кирпичная крошка, куски гипсокартона,
                            штукатурка, бетон и металлические конструкции. И всё это по окончанию работ куда-то нужно
                            девать.</p>
                        <p>Обращаясь в компанию ООО «УМ-2020» клиент может рассчитывать, что наши сотрудники:</p>
                        <ul class="info__list">
                            <li>вывезут строительный мусор, используя современную технику в сроки, необходимые
                                заказчику;</li>
                            <li>вывезут габаритные и массивные строительные отходы на спецтехнике для негабаритных
                                грузов;</li>
                            <li>погрузят скопившийся хлам на транспорт;</li>
                            <li>предоставят документацию по факту выполненных работ.</li>
                        </ul><img class="service-page__image-mobile" alt="service-img"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item4.webp">
                        <p>Нами гарантируется высокое качество и приемлемые цены на услуги по вывозу строительных
                            отходов. Мы предоставим грузчиков и специализированный транспорт, а также погрузочную
                            технику. В нашем парке есть все необходимое оборудование, чтобы работы были выполнены быстро
                            и качественно.</p>
                    </div>
                    <div class="info__call-button">Подробнее</div>
                </div>
            ...
            <div class="services-page__item">
                <div class="services-page__info">
                    <div class="info__title">Доставка негабаритных грузов</div>
                    <div class="info__text">
                        <p>Часто разным компаниям и частным предпринимателям приходится перевозить негабаритные грузы.
                            Это довольно востребованная услуга в Беларуси. Её популярность обусловлена тем, что редкие
                            организации в парке содержат спецтехнику способную транспортировать грузы нестандартных
                            размеров. Часто такая услуга требуется для перевозки промышленного оборудования,
                            стройматериалов или сельхозтехники.</p><img class="service-page__image-mobile"
                            alt="service-img"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item5.webp">
                        <p>Мы предлагаем услуги спецтехники, которая подойдёт для транспортировки нестандартного груза.
                            Клиенты могут, как арендовать машину отдельно, так и с нашим оператором, если в штате нет
                            собственного специалиста.</p>
                    </div>
                    <div class="info__call-button">Подробнее</div>
                </div>
                <div class="services-page__image">
            ...
            <div class="services-page__item">
                <div class="services-page__image">
                    <div class="helper"></div><img alt="service-img"
                        src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item6.webp">
                </div>
                <div class="services-page__info">
                    <div class="info__title">Уборка и вывоз снега</div>
                    <div class="info__text">
                        <p>Уборка снега — это комплексная работа, требующая особого подхода. Сотрудники нашей компании:
                        </p>
                        <ul class="info__list">
                            <li>очистят прилегающие территории снегоуборочной техникой со щётками;</li>
                            <li>соберут снежные массы в сугроб с помощью компактного бульдозера;</li>
                            <li>погрузят снег погрузчиком и вывезут на самосвале.</li>
                        </ul><img class="service-page__image-mobile" alt="service-img"
                            src="<?php echo get_template_directory_uri(); ?>/assets/images/service-item6.webp">
                        <p>В нашем парке можно арендовать мини-трактор и навесное оборудование к нему. Также мы
                            предлагаем крупнотоннажную технику, использование которой помогает вывезти снег на
                            специализированный полигон.</p>
                    </div>
                    <div class="info__call-button">Подробнее</div>
                </div>
            </div>
    ...
    <div class="info service-page-info-2">
        <div class="container">
            <div class="info__full">
                <div class="info__title">Почему ООО «УМ-2020»</div>
                <div class="info__text">
                    <p>Сегодня спецтехника используется в бытовых и промышленных сферах. Она обеспечивает непрерывную
                        работу крупного дорожно-строительного предприятия или мелкого частного предпринимателя.
                        Сотрудничая с компанией ООО «УМ-2020» клиенты могут рассчитывать на следующие преимущества:</p>
                    <ul class="info__list">
                        <li>Оказание услуг спецтехники по выгодной стоимости.</li>
                        <li>Бесплатную консультационную помощь опытных менеджеров.</li>
                        <li>Предоставление опытных операторов.</li>
                        <li>Официальное сотрудничество в соответствии с условиями договора.</li>
                    </ul>
                    <p>Если срочно потребовалось оказание услуг спецтехники достаточно связаться с нашими консультантами
                        по телефону, оставить заявку онлайн или лично посетить офис компании.</p>
                </div>
