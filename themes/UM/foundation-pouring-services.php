 ...
 * @package sss
 * 
 * Template Name: Foundation pouring services
 */
...
<main>
	<div id="rent-banner"
		class="main-banner rent-banner services-page-banner construction-services-banner foundation-pouring-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Услуги по заливке фундамента</h1>
				<div class="main-banner__text">Заливка под фундамент является начальным этапом строительных работа при
					возведении зданий или сооружений разного назначения. Задача строительной бригады обеспечить
					прочность основания, от которой зависит долговечность строения. И это под силу профессионалам ООО
					«УМ-2020».</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img
					...
					class="catalog__location-current">Услуги по заливке фундамента</span></div>
...
?>
	...
	<div
		class="services-page-items construction-services-banners-items repair-of-buildings-items foundation-pouring-items">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Важность прочного основания</div>
				<div class="info__text">Чтобы понять, насколько важны качественные услуги по заливке фундамента нужно
					учитывать задачи, решаемые основанием под домом:</div>
				<ul class="info__list">
					<li>стабилизация грунта под строением для обеспечения необходимой жесткости;</li>
					<li>выравнивание площадки под строительство дома;</li>
					<li>поддержание сухости в помещениях;</li>
					<li>задержка газов, содержащихся в грунте;</li>
					<li>защита здания от грунтовой воды.</li>
				</ul>
				<div class="info__text">Если заливка фундамента выполнена в соответствии с установленными нормами и
					требованиями, то это гарантирует прочную основу строения и как следствие его долговечность.</div>
			</div>
			<div class="info__block">
				<div class="info__left">
					<div class="info__title">Марка бетона для заливки</div>
					<div class="info__text">
						<p>Марку бетона важно выбирать в соответствии с конструктивными особенностями основания.
							Малоэтажное строение возводят на бетонной смеси марки 400. Фундамент под забор можно
							заливать цементным составом марки 200.</p>
						<p>Для обеспечения беспрерывной заливки фундамента, для получения монолитного бетонного
							основания, раствор подвозится в специальных миксерах. В ООО «УМ-2020» есть вся необходимая
							техника для обеспечения беспрерывного рабочего процесса. Это гарантирует высокое качество
							предоставляемых услуг.</p>
					</div>
				</div>
				<div class="info__right">
					<div class="info__title">Заливка бетона зимой</div>
					<div class="info__text">Услуга заливка фундамента под дом может потребоваться как летом, так и
						зимой. В последнем случае для получения прочного основания наши профессионалы:</div>
					<ul class="info__list">
						<li>прогревают весь участок совместно с фундаментом;</li>
						<li>прогревают бетонную смесь;</li>
						<li>добавляют специальные вещества.</li>
					</ul>
					<div class="info__text">Работать с электронагревательным кабелем должны только профессионалы
						способные соблюсти правила безопасности. Поэтому самостоятельно проводить заливку бетона в мороз
						не рекомендовано.</div>
				</div>
			</div>
			<div class="info__block">
				<div class="info__left">
					<div class="info__title">Этапы бетонных работ</div>
					<div class="info__text">
						<p>Стоимость заливки фундамента зависит от общей площади и используемых материалов. Также
							ценообразование может меняться от качества грунта и веса конструкции дома. Чтобы избежать
							распространенных проблем работы лучше доверить профессионалам ООО «УМ-2020» способным
							произвести правильные расчеты, подготовить строительную площадку и задействовать
							спецтехнику.</p>
						<p>Когда подготовительные работы завершены наши сотрудники:</p>
					</div>
					<ul class="info__list">
						<li>уплотняют песчаную подушку вперемешку со щебнем;</li>
						<li>монтируют арматурный каркас для дополнительной прочности бетона;</li>
						<li>прокладывают инженерные коммуникации;</li>
						<li>устанавливают опалубку, изготовленную из дерева;</li>
						<li>заливают бетонную смесь соответствующей марки;</li>
						<li>тщательно разравнивают поверхность по периметру.</li>
					</ul>
					<div class="info__text">Нами выполняется заливка фундамента под частные малоэтажные строения и
						другие объекты. Мы гарантируем что все работы будут выполнены вовремя с учётом технологического
						процесса обеспечивающего максимальный срок службы здания.</div>
				</div>
				<div class="info__right">
					<div class="info__title">Заливка основания</div>
					<div class="info__text">
						<p>Прежде чем заливать бетонную смесь, выполняется подготовка площадки вокруг основания для
							обеспечения доступа машин с раствором ко всем углам фундамента. Во время заливки цементного
							раствора параллельно проводится трамбовка для удаления пузырьков воздуха. С этой целью мы
							пользуемся специальным глубинным вибратором. Состав, которым заполнена опалубка
							разравнивается по уровню.</p>
						<p>Для итогового высыхания фундамента требуется не менее 3-х недель. Начинать строительство
							раньше не рекомендуется. Для предотвращения образования трещин бетонная смесь периодически
							поливается водой. Если на улице высокая температура основание накрывается полиэтиленовой
							пленкой для уменьшения испарения влаги.</p>
					</div>
				</div>
			</div>
			<div class="info__full mt-0">
				<div class="info__title">Цена качественных услуг</div>
				<div class="info__text info__text-long">Расценки на качественные строительные услуги не могут быть
					дешевыми, так как от этого зависит надёжность и долговечность бедующей постройки. Нами предлагается
					заливка фундамента цена, в Минске которой зависит от следующих особенностей:</div>
				<ul class="info__list">
					<li>материалов, использованных во время заливки;</li>
					<li>типа основания дома;</li>
					<li>сложности и объема работ;</li>
					<li>задействованной спецтехники.</li>
				</ul>
				<div class="info__text info__text-long">Самостоятельно заливая бетонную смесь, неопытные строители
					допускают непростительные ошибки, из-за которых в будущем появятся трещины на фасаде здания. Поэтому
					услуги заливка фундамента цена которой формируется из разных факторов должна выполняться
					профессионалами ООО «УМ-2020».</div>
			</div>
			<div class="info__full mt-0 mb-0">
				<div class="info__title">Фундамент от ООО «УМ-2020» под ключ</div>
				<div class="info__text info__text-long">Комплексная работа по формированию основания дома нашими
					профессионалами подразумевает четкую последовательность:</div>
				<ul class="info__list">
					<li>Заливка под фундамент начинается с выезда нашего эксперта на строительный объект с целью осмотра
						площадки и оценки предстоящих работ.</li>
					<li>Проводятся инженерные изыскания для определения гидрологических особенностей грунта.</li>
					<li>Выбирается тип основания исходя из особенностей местности и характера почвы.</li>
					<li>Проводится ряд подготовительных мероприятий, включающих вертикальную планировку, устройство
						путей для подъезда спецтехники.</li>
					<li>Снимается плодородный слой, роется котлована или траншея, вывозится грунт с целью дальнейшей
						утилизации.</li>
					<li>Устанавливается съемная опалубка и формируется металлический каркас из арматуры.</li>
					<li>Заливается бетонная смесь с дальнейшим удалением пузырьков воздуха путём трамбовки специальным
						оборудованием.</li>
				</ul>
				<div class="info__text info__text-long">Мы ответственно подходим к каждому этапу для достижения
					поставленного результата. Благодаря практическому опыту реализации строительных проектов заливка
					фундамента под дом от наших профессионалов проходит без ошибок, что обеспечивает долговечность и
					прочность основания.</div>
			</div>
		</div>
	</div>
	<div class="feedback">
	...
	<div class="info construction-services-info foundation-pouring-info">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Почему клиенты доверяют нам</div>
				<div class="info__text">Наша цель – создание выгодных и плодотворных условий сотрудничества всем
					клиентам. Обращаясь за заливкой ленточного основания под ключ, к нам клиенты могут рассчитывать на
					следующие преимущества:</div>
				<ul class="info__list">
					<li>Доступную цену профессиональных услуг. У нас всегда актуальное ценообразование в соответствии с
						ситуацией на рынке.</li>
					<li>Использование спецтехники. В нашем автопарке есть вся необходимая техника для проведения полного
						цикла работ.</li>
					<li>Гарантию на весь комплекс работ. Нами предоставляется гарантия на проведенные работы, так как мы
						уверены в их качестве.</li>
					<li>Контроль выполнения всех этапов. Это позволяет избежать распространенных рисков при заливке
						фундамента.</li>
					<li>Сотрудничество по официальному договору. С каждым клиентом подписывается договор, в котором
						фиксируются важные условия сотрудничества.</li>
				</ul>
