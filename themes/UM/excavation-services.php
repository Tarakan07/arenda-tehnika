 ...
 * @package sss
 * 
 * Template Name: Excavation services
 */
...
<main>
	<div id="rent-banner"
		class="main-banner rent-banner services-page-banner construction-services-banner excavation-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Земляные работы</h1>
				<div class="main-banner__text">
					<p>Земляные работы включают в себя выемку или разработку грунтов, складирование или перемещение в
						места согласно проектной документации, а также процессы уплотнения и разравнивания.</p>
					<p>Закажите специальную технику компании «УМ-2020»: бульдозеры и экскаваторы, погрузчики и
						самосвалы. Создание грунтовых инженерных объектов или оснований под них будет достигнуто в
						указанные сроки.</p>
				</div>
			</div>
...
?>
	...
	<div class="services-page-items construction-services-banners-items repair-of-buildings-items excavation-items">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Земляные работы специальной техникой компании «УМ-2020»</div>
				<div class="info__text">
					<p>Арендованная строительная техника компании гораздо дешевле и с высоким качеством выполнит
						земляные работы, чем механизмы из любого собственного парка. Не нужно искать средства на покупку
						техники, на ремонт, хранение и обслуживание, на обучение персонала.</p>
					<p>Техника компании всегда исправна и круглосуточно готова к работе. Менеджеры предприятия оказывают
						бесплатные консультации по подбору техники и необходимого оборудования для всех мероприятий с
						землей. Механики и операторы оборудования круглосуточно готовы к действиям. Договор аренды
						техники оформляется мгновенно.</p>
					<p>Производство земляных работ — серьезный и специфический этап строительного производства. Он
						многогранен: от планировки до благоустройства прилегающей территории. На этом этапе должна быть
						строжайшая дисциплина, ибо от качества труда с землей зависит качество фундаментов и проложенных
						в земле коммуникаций.</p>
					<p>Перед работой с землей обязательно должен быть проведен этап подготовки. Необходимо провести
						вынужденные мероприятия:</p>
				</div>
				<ul class="info__list">
					<li>Старые здания и фундаменты должны быть демонтированы;</li>
					<li>Деревья, пни, растительность подлежат ликвидации или возможному перемещению;</li>
					<li>Территория вычищается от любого мусора;</li>
					<li>Продумываются подъездные пути и их состояние для беспрепятственного проезда техники;</li>
					<li>Проводятся согласования мероприятий, требующих экологического вмешательства.</li>
				</ul>
				<div class="info__text">
					<p>Земляные работы необходимы для разработки котлованов и установки фундаментов. Разработка
						котлованов предполагает размещение в них различных видов фундаментов и сооружений. Для
						разработки понадобятся экскаваторы, вырытую землю будут отвозить самосвалы: компания сдает в
						аренду такую технику.</p>
					<p>Фундаменты заливаются в специальные выемки земли, которые бывают трех видов: ямы предназначены
						для отдельно стоящих столбов и фундаментов; траншеи готовят для средств связи; в котлованы
						укладывают фундаменты ленточные.</p>
				</div>
			</div>
			<div class="info__block">
				<div class="info__left">
					<div class="info__title">Земляные работы по рытью траншей и выравниванию</div>
					<div class="info__text">
						<p>Траншея представляет собой выемку, узкую и длинную, с необходимой глубиной. В ней
							прокладывают трубо- и газопроводы, телефонные кабели, инженерные сети, другие средства
							сообщений и связи. Копают траншеи экскаваторы компании. Оборудование подбирают по типу
							траншеи и с учетом экономии средств.</p>
						<p>Рабочие действия с землей в девяноста процентах случаев требует выравнивания участков под
							различные нужды. Выравнивание придает рельефу форму, необходимую для производства
							последующих земляных и строительных работ. Выравнивание производят бульдозерами компании,
							срезая холмы, засыпая овраги, другое.</p>
						<p>Мероприятия с землей включают в себя дорожные работы, целью которых выровнять основания под
							временную дорогу. Ведется подсыпка или изымание грунта на основании, затем проводится
							тщательное выравнивание. Также проводится накладывание песка и щебня для создания прочного
							рабочего дорожного покрытия.</p>
						<p>Без перемещения грунтов не обходятся никакие земляные работы. Используют три вида
							перемещения:</p>
					</div>
					<ul class="info__list">
						<li>Малое. Грунт перемещается на близкое расстояние, для этого хватает длины ковша экскаватора;
						</li>
						<li>Среднее перемещение составляет двадцать метров и производит его погрузчик;</li>
						<li>Дальнее. Самосвалы компании переместят грунт на указанные расстояния.</li>
					</ul>
					<div class="info__text">Котлованы часто нуждаются в обратной засыпке, поскольку после окончания
						работ с фундаментом, случаются пустоты и проседания. Обратная засыпка требуется для траншей, в
						которых проложены средства связи. Засыпку профессионально выполняет экскаватор-погрузчик
						компании.</div>
				</div>
				<div class="info__right">
					<div class="info__title">Работы с мерзлой землей и уплотнение грунта</div>
					<div class="info__text">
						<p>Земляные работы запросто проводятся в зимнее время. Стоимость и скорость работ в холодное
							время меняются, а качество остается летним. Все характеристики зимних работ сильно зависят
							от типа грунтов.</p>
						<p>Во время предварительной подготовки к действиям с землей в зимнее время предпринимаются меры
							по частичному оттаиванию грунта. Затем проводятся обычные мероприятия. Мерзлый грунт режется
							на мелкие блоки и извлекается из выемки.</p>
						<p>Уплотнение грунта проводится после снятия с фундамента гидроизоляции и опалубки.
							Образовавшиеся пустоты вокруг фундамента засыпают и затем уплотняют грунт. Категорически
							запрещается производить засыпку и уплотнение с мусором.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<div class="info construction-services-info foundation-pouring-info excavation-info">
		<div class="container">
			<div class="info__title">С компанией «УМ-2020» любые земляные работы по плечу</div>
			<div class="info__left">
				<div class="info__text">
					<p>Менеджмент предприятия чувствует себя уверенно на рынке специальной техники для работ с землей.
						Здесь подберут выгодные варианты с техникой, ценами, оплатой, с обученным персоналом. Здесь Вы
						решите все вопросы, связанные с производством земельных работ.</p>
					<p>Производство земляных работ предполагает интенсивное использование специальной техники и
						дополнительных приспособлений. Здесь услуги и варианты, выгодные и доступные каждому клиенту:
					</p>
				</div>
				<ul class="info__list">
					<li>Работы с землей: рытье траншей и прокладка нужных людям средств связи; рытье котлованов и
						вертикальная планировка; создание насыпей и дорожные работы; перемещение грунта и мусора;
						обратная засыпка и уплотнение грунта; другое;</li>
					<li>Аренда специальной техники — это вариант, когда потребность в технике есть, а покупать ее
						необходимости нет. Здесь подберут выгодный и полезный вариант;</li>
					<li>Аренда специальной техники с правом выкупа. Здесь клиентам дают право выбрать время, когда
						арендованная техника станет Вашей собственностью;</li>
					<li>Ремонт и профессиональное сервисное обслуживание оборудования и техники специального назначения.
					</li>
				</ul>
			</div>
			<div class="info__right">
				<div class="info__text">Очевидные плюсы сотрудничества с компанией:</div>
				<ul class="info__list">
					<li>В парке техники в наличии: краны и бульдозеры, погрузчики и самосвалы, экскаваторы, другое,
						среди которых можно найти клиенту выгодный вариант;</li>
					<li>Исправность техники гарантируется ежедневной проверкой перед выездом на задание;</li>
					<li>Наличие вариантов с оборудованием — это правильно подобранная и приемлемая стоимость услуги;
					</li>
					<li>Юридически четкий и понятный договор защищает обе стороны сделки.</li>
				</ul>
				<div class="info__text">Заказывайте работы любой сложности! Земляные работы, для выполнения которых
					придет в движение специальная техника компании «УМ-2020» с необходимыми характеристиками, будут
					выполнены в указанные сроки.</div>
