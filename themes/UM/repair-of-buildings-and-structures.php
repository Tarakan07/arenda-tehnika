 ...
 * @package sss
 * 
 * Template Name: Repair of buildings and structures
 */
	...
	<div id="rent-banner" class="main-banner rent-banner services-page-banner construction-services-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Ремонт зданий и сооружений</h1>
				<div class="main-banner__text">Капитальный ремонт здания – комплекс восстановительных технических
					операций, призванный ликвидировать износ за время эксплуатации. На частоту проведения ремонтных
					работ влияют сроки продуктивного использования строения. Они определяются персонально в каждом
					конкретном случае.</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img
					...
					class="catalog__location-current">Ремонт зданий и сооружений</span></div>
...
?>
	...
	<div class="services-page-items construction-services-banners-items repair-of-buildings-items">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Особенности ремонта зданий и сооружений</div>
				<div class="info__text">
					<p>ООО «УМ-2020» предлагает ремонтные работы в Республике Беларусь на привлекательных для клиентов
						условиях. Нами используется персональный подход в изучении износа и повреждений сооружений. Мы
						отталкиваемся от минимального бюджета заказчиков.</p>
					<p>Чтобы восстановление или реконструкция сооружений и других строительных объектов прошла успешно
						учитываются конструктивные особенности зданий, их техническое состояние, эксплуатационные нюансы
						и климат в конкретном регионе. Чтобы определить оптимальный алгоритм работ для проведения
						ремонта, важно выяснить категорию объекта по капитальности, а также степень его износа.</p>
					<p>Комплексный ремонт здания — это ряд мероприятий направленных на устранение выявленных проблем.
						Профессионалы ООО «УМ-2020» восстанавливают функциональность, и устраняют следы износа любого
						сооружения.</p>
				</div>
			</div>
			<div class="info__block">
				<div class="info__left">
					<div class="info__title">Плановые и внеплановые мероприятия</div>
					<div class="info__text">
						<p>Клиенты могут заказать плановый и внеплановый ремонт зданий в зависимости от сложившейся
							ситуации. Первый вариант подразумевает проведение запланированных работ для поддержания
							объекта в соответствующем состоянии. Во втором случае ремонт необходим при обнаружении
							незапланированных проблем.</p>
						<p>В зависимости от состояния объекта наши сотрудники:</p>
					</div>
					<ul class="info__list">
						<li>ремонтируют и проводят внутреннюю отделку помещений, не меняя конструктивные элементы;</li>
						<li>восстанавливают поврежденные покрытия;</li>
						<li>ремонтируют и модернизируют здания и сооружения, обновляя обстановку;</li>
						<li>меняют изношенный крепёж и другие конструктивные элементы;</li>
						<li>подключают необходимое клиенту оборудование;</li>
						<li>частично меняют инженерные системы.</li>
					</ul>
					<div class="info__text">Мы ремонтируем производственные помещения, офисы, административные центры,
						магазины, поликлиники, торговые залы. Каждый случай требует подбора соответствующих
						стройматериалов и технологий, а также строительной техники. Нами выполняются плановые и
						внеплановые мероприятия. Работы проводятся результативно и в сроки, установленные договором.
					</div>
				</div>
				<div class="info__right">
					<div class="info__title">Работы по реконструкции и ремонту</div>
					<div class="info__text">
						<p>Мы досконально разбираемся в нюансах восстановления зданий и сооружений с постоянно высокой
							нагрузкой и потоком людей. Нами выполняются капитальные и косметические работы с внедрением
							проверенных технологий и стройматериалов.</p>
						<p>Комплексный ремонт здания от ООО «УМ-2020» состоит из:</p>
					</div>
					<ul class="info__list">
						<li>демонтажа элементов с сильным износом;</li>
						<li>замены конструкций, не подлежащих восстановлению;</li>
						<li>сноса объектов в аварийном состоянии;</li>
						<li>полного обновления отделки снаружи и внутри;</li>
						<li>восстановления и замены коммуникационных систем;</li>
						<li>прокладки скрытой электропроводки;</li>
						<li>перепланировки по желанию заказчика;</li>
						<li>подключения оборудования.</li>
					</ul>
					<div class="info__text">Перед началом проводится доскональный анализ объекта с целью поиска
						вариантов по устранению проблем. Капитальные мероприятия и реконструкция от ООО «УМ-2020»
						является окупаемой инвестицией. На расценки влияет состояние объекта и объем предстоящих работ.
					</div>
				</div>
			</div>
			<div class="info__block mb-0">
				<div class="info__title">Обслуживание объектов</div>
				<div class="info__left">
					<div class="info__text">
						<p>Обслуживание здания и сооружения является популярной услугой в Республике Беларусь. Оно
							нацелено на поддержание помещений жилого и нежилого характера в пригодном для целевого
							использования состоянии. Мы персонально подходим к каждому клиенту и обслуживаем объекты в
							соответствии с условиями договора заключённого с заказчиком.</p>
						<p>Обслуживание ремонта здания состоит из:</p>
					</div>
					<ul class="info__list">
						<li>ликвидации последствий аварийной ситуации;</li>
						<li>организации анализа строений для обнаружения проблем;</li>
						<li>проведения работ, обеспечивающих энергоснабжение;</li>
						<li>ведения технических документов;</li>
						<li>контроля состояния здания или сооружения.</li>
					</ul>
				</div>
				<div class="info__right">
					<div class="info__text">Услуги по обслуживанию и ремонту зданий и сооружений в ООО «УМ-2020» обычно
						заказывают собственники таких объектов, как:</div>
					<ul class="info__list">
						...
						<li>административные центры;</li>
						<li>жилищные комплексы.</li>
					</ul>
				</div>
			</div>
			<div class="info__full mt-0 mb-0">
				<div class="info__text repair-of-buildings-long-text">Наш опыт работы на рынке Республики Беларусь
					помогает предоставить клиентам полный комплекс услуг. Заказчикам не придется обращаться в другие
					компании для отделки, малярных работ или замены коммуникаций – все это наша забота.</div>
			</div>
		</div>
	</div>
	<div class="feedback">
	...
	<div class="info construction-services-info repair-of-buildings-info">
		<div class="container">
			<div class="info__left">
				<div class="info__title">Почему клиенты доверяют нам</div>
				<div class="info__text">
					<p>ООО «УМ-2020» – это коллектив профессиональных рабочих, способных выполнить ремонт любой
						сложности под ключ. Мы стали партнером для клиентов в Минске и области. Мы выполняем ремонт,
						обслуживание и реконструкцию жилых и нежилых зданий и сооружений. Мы дорожим репутацией и
						нацелены на долгосрочное сотрудничество, предоставляя высокий уровень услуг.</p>
					<p>Сотрудничество с нами подразумевает ряд преимуществ для клиентов:</p>
				</div>
				<ul class="info__list">
					<li>Актуальную цену на обслуживание, капитальный ремонт здания или сооружения.</li>
					<li>Услуги генерального подрядчика и субподрядчика.</li>
					<li>Опытный штат рабочих разных строительных специальностей.</li>
					<li>Укомплектованную материальную и техническую базу.</li>
					<li>Наличие необходимых разрешений для ведения строительных работ в Минске.</li>
					<li>Использование качественных и экологически безопасных стройматериалов.</li>
					<li>Наличие необходимого инструмента и оборудования.</li>
				</ul>
				<div class="info__text">Мы берём на себя обязательства по выполнению комплексных работ и последующему
					сопровождению. Мы занимаемся всеми аспектами, предоставляя клиентам полный комплекс услуг. Если
					нужен капитальный ремонт здания, его обслуживание или реконструкция, то достаточно связаться с
					нашими менеджерами по телефону или оставить заявку онлайн.</div>
			</div>
			<div class="info__right">
				<div class="info__title">Цены на обслуживание и ремонт</div>
				<div class="info__text">
					<p>Ремонт зданий и сооружений снаружи и внутри может быть капитальным или косметическим. Это
						напрямую влияет на ценообразование предстоящих мероприятий. Нами учитывается объём работ,
						количество задействованных узкопрофильных рабочих, техники и оборудования.</p>
					<p>На стоимость ремонта и обслуживания, также влияют:</p>
				</div>
				<ul class="info__list">
					<li>общие размеры помещений;</li>
					<li>тип объекта: жилой или нежилой;</li>
					<li>вид предстоящего ремонта;</li>
					<li>используемые стройматериалы.</li>
				</ul>
				<div class="info__text">
					<p>Для составления сметы на объект выезжает наш представитель. Он осматривает здание или сооружение
						для определения объема предстоящих работ. Если потребовался качественный ремонт стоит обращаться
						к профессиональному исполнителю.</p>
					<p>ООО «УМ-2020» выполнит полный комплекс мероприятий в соответствии с графиком по выгодной
						стоимости. Мы сотрудничаем с проверенными поставщиками стройматериалов и имеем собственный
						автопарк для выполнения полного цикла ремонтных работ.</p>
				</div>
