...
<main>
	<div id="rent-banner" class="main-banner rent-banner selling-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Продажа спецтехники</h1>
				<div class="main-banner__text">
					<p>Продажа спецтехники популярна среди организаций Республики Беларусь, предоставляющих строительные и
						монтажные работы. Приобретаются как новые, так и подержанные машины для транспортировки грузов, рытья
						котлованов, подъема людей и оборудования на высоту и других целей.</p>
					<p>Крупные организации приобретают новую спецтехнику, начинающим предпринимателям выгоднее покупать
						подержанные машины, не изымая существенную сумму из оборота компании. При этом найти выгодные предложения
						можно на сайте ООО «УМ-2020».</p>
				</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<?php if ( function_exists( 'dimox_breadcrumbs' ) ) dimox_breadcrumbs('Продажа спецтехники'); ?>
	...
	<div class="conditions selling-conditions">
		<div class="container">
			<div class="conditions__title">Какую спецтехнику можно купить</div>
			<div class="conditions__top">
				<div class="conditions__text">
					<p>Чтобы купить надежную и долговечную спецтехнику лучше сотрудничать с надежным продавцом. Сегодня продажа
						строительной техники в Минске – приоритетное направление работы ООО «УМ-2020». У нас огромный автопарк
						современного оборудования, известных производителей, нового и бывшего в употреблении.</p>
					<p>Мы предлагаем заказчикам подъемные, землеройные и дорожно-транспортные машины. У нас клиенты могут купить:
					</p>
					<ul class="info__list">
						<li>автокран и автовышку;</li>
						<li>бульдозер и грунторез;</li>
						<li>гидромолот и каток;</li>
						<li>погрузчик и экскаватор;</li>
						<li>самосвал и другие машины.</li>
					</ul>
					<p>Продажа спецтехники в Беларуси – популярная услуга. Мы предлагаем не только надежную спецтехнику, а и
						дальнейшее её обслуживание. Покупая оборудование у нас, клиент получает качественную машину с большим сроком
						службы независимо от того, является она новой или бывшей в употреблении.</p>
				</div>
				<div class="conditions__right"><img class="conditions__image" alt="excavator"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/selling-excavator.webp"></div>
				<p class="conditions__text-mobile">Продажа спецтехники в Беларуси – популярная услуга. Мы предлагаем не только
					надежную спецтехнику, а и дальнейшее её обслуживание. Покупая оборудование у нас, клиент получает качественную
					машину с большим сроком службы независимо от того, является она новой или бывшей в употреблении.</p>
			</div>
		</div>
	</div>
	<div class="info selling-info">
		<div class="container">
			<div class="info__left">
				<div class="info__title">Правила выбора спецтранспорта</div>
				<div class="info__text">Для выгодного вложения средств в спецтехнику при подборе нужно учитывать технические
					параметры и следующие нюансы:</div>
				<ul class="info__list">
					<li>результативность использования машин в соответствии с масштабами компании;</li>
					<li>сопутствующие расходы на ремонт, обслуживание и эксплуатацию;</li>
					<li>наличие в свободной продаже запчастей и расходных материалов;</li>
					<li>сервисные центры в регионе работы компании.</li>
				</ul>
				<div class="info__text">Продажа строительной и спецтехники в Минске является одним из наших направлений работы.
					Мы помогаем клиентам проанализировать рентабельность вложений в зависимости от поставленных задач и условий
					эксплуатации оборудования.</div>
			</div>
			<div class="info__right">
				<div class="info__title">Новые или подержанные машины</div>
				<div class="info__text">Часто строительным компаниям необходима специализированная техника для реализации
					поставленных задач. Некоторые организации арендуют краны, экскаваторы и другие машины. Однако крупным фирмам,
					нацеленным на долгосрочное предоставление услуг на рынке Белоруссии важно иметь собственный автопарк. Если
					денег на приобретение нового оборудования недостаточно, то можно рассмотреть вариант покупки спецтехники
					бывшей в употреблении.</div>
				<div class="info__text">Выбор между новой и б/у техникой должен основываться на долгосрочных перспективах
					строительной компании. На начальном этапе развития бизнеса не всегда рентабельно изымать крупную сумму из
					оборота для приобретения новых машин. В данной ситуации выгоднее покупка подержанного оборудования.</div>
				<div class="info__text">Важно приобретать погрузчики, бульдозеры и другое оборудование у проверенных продавцов,
					таких как ООО «УМ-2020». Благодаря собственному автопарку мы можем предложить хороший выбор клиентам в
					соответствии со специализацией работы частного предпринимателя или крупной юридической компании.</div>
			</div>
			<div class="info__full">
				<div class="info__title">Подбор подержанной техники</div>
				<div class="info__text">Покупка и продажа спецтехники в Беларуси, бывшей в употреблении, чем-то напоминает
					импровизированную лотерею. Это обусловлено покупкой машин с критическим износом и скрытыми поломками. Поэтому
					важно сотрудничать с продавцом, предоставляющим правдивую историю техники.</div>
				<div class="info__text">ООО «УМ-2020» предлагает не только надежные строительные машины, а и документацию,
					подтверждающую прохождение регулярных техосмотров. Нами проводится полная предпродажная подготовка, чтобы
					купленное клиентами оборудование проработало долго без поломок и других существенных проблем.</div>
				<div class="info__text">Покупая подержанную спецтехнику нужно понимать, что рабочие машины не могут стоить
					слишком дёшево. Наши эксперты при выборе транспорта бывшего в употреблении рекомендуют следовать простым
					правилам:</div>
				<ul class="info__list">
					<li>Приобретать технику на официальных торгах или напрямую у владельцев. Сегодня продажа спецтехники активно
						ведется на аукционах.</li>
					<li>Уделять внимание частоте и качеству технического обслуживания спецтехники. Хорошо если продавец
						предоставит сервисную книжку с отметками о прохождении ТО у официального дилера.</li>
					<li>Не покупать специализированный транспорт по непристойно выгодной цене. Привлекательная стоимость должна
						настораживать и подталкивать провести комплексную диагностику.</li>
					<li>Отдавать предпочтение работающей спецтехнике, а не машинам, которые долго простаивали в гараже, ожидая
						своего покупателя.</li>
					<li>Не приобретать машины и оборудование возрастом более 10 лет. К старой спецтехнике сложно найти запасные
						части, комплектующие и расходные материалы, из-за чего возникнут проблемы с дальнейшим обслуживанием.</li>
					<li>Покупать оборудование известных производителей. Обычно такая техника отличается прочностью и большим
						сроком службы.</li>
				</ul>
				<div class="info__text">Продажа спецтехники в Белоруссии — это выгодный и удобный способ пополнить автопарк
					надежным оборудованием. Мы нацелены на долгосрочное и результативное сотрудничество с клиентами, предоставляя
					качественные и долговечные машины.</div>
			</div>
		</div>
	</div>
	<div class="feedback">
	...
	<div class="info selling-info">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Выгода сотрудничества с нами</div>
				<div class="info__text info__text-long">В нашем автопарке огромное количество новой и бывшей в употреблении
					спецтехники. Каждая машина доступна к смотру перед покупкой. Это позволит покупателям убедиться в её качестве
					и надежности. Мы не препятствуем прохождению диагностики в сервисном центре, выбранном клиентом. У нас на всё
					оборудование имеется необходимая документация. Продажа спецтехники б/у и новой в ООО «УМ-2020» всегда проходит
					оперативно и безопасно для каждого клиента.</div>
				<div class="info__subtitle">Сотрудничество с нами подразумевает следующие преимущества для покупателей:</div>
				<div class="info__list-wrap">
					<ul class="info__list">
						<li>гарантия качества всех технических единиц в нашем автопарке;</li>
						<li>гарантийное и послегарантийное обслуживание спецтехники, купленной у нас;</li>
						<li>персональные условия сотрудничества для покупателей;</li>
						<li>рациональное решение задач, поставленных клиентами;</li>
						<li>выбор машин и оборудования к ним;</li>
					</ul>
					<ul class="info__list">
						<li>помощь в подборе спецтехники в зависимости от задач клиента;</li>
						<li>возможность быстро забрать спецтехнику в нашем автопарке;</li>
						<li>доставку оборудования по желанию заказчика;</li>
						<li>реальную наработку реализуемых машин и оборудования;</li>
						<li>минимальную гарантию на проверку подержанной спецтехники.</li>
					</ul>
				</div>
				<div class="info__text info__text-long">Для получения подробной информации можно связаться с нашими менеджерами
					по телефону либо другим способом доступным на сайте. Чтобы продажа спецтехники прошла результативно, наши
					эксперты помогут подобрать машину с минимальным износом в соответствии с направленностью работы компании.
				</div>
