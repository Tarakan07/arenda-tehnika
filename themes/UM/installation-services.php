 ...
 * @package sss
 * 
 * Template Name: Installation services
 */
...
<main>
	<div id="rent-banner"
		class="main-banner rent-banner services-page-banner construction-services-banner installation-services-banner">
		<div class="container">
			<div class="main-banner__left">
				<h1 class="main-banner__title">Услуги монтажных работ</h1>
				<div class="main-banner__text">Услуги монтажных работ — это комплекс взаимосвязанных механизированных
					операций создающих основу для проведения других строительных мероприятий. Они подразумевают
					установку элементов каркаса здания, конструкций из железобетона металла или дерева. Это трудоемкий
					процесс, требующий соблюдения установленных норм и требований для обеспечения надежности и
					долговечности будущего объекта.</div>
			</div>
	...
	<div class="catalog">
		<div class="container">
			<div class="catalog__location"><a class="catalog__location-history" href="/">Главная</a> <img
					...
					class="catalog__location-current">Услуги монтажных работ</span></div>
		...
		<div class="container">
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Монтаж сборных и железобетонных конструкций</div>
					<div class="info__text">Монтаж бетонных и железобетонных конструкций популярен в строительстве
						объектов промышленного и гражданского фонда. Это обусловлено следующими преимуществами:</div>
					<ul class="info__list">
						<li>прочностью и долговечностью;</li>
						<li>возможностью создания любых форм;</li>
						<li>доступной ценой.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-15.webp">
					<div class="info__text">Отличие сборной конструкции от монолитной заключается в транспортировке на
						место строительства в готовом к монтажу виде. Их установка напоминает сборку элементов
						конструктора с помощью оборудования. Главное, чтобы работы выполнялись профессионалами ООО
						«УМ-2020».</div>
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-16.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Возведение каменных и армокаменных конструкций</div>
					<div class="info__text">
						<p>Каменные и армокаменные конструкции начинают возводить с подготовки проекта будущего здания.
							Учитывается нагрузка, создаваемая несущими стенами, климатические особенности региона, чтобы
							строение противостояло воздействию механических и природных внешних факторов.</p><img
							class="service-page__image-mobile" alt="service-img"
							src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-16.webp">
						<p>Наши эксперты подберут подходящий материал для строительных работ. Когда укладка кирпичей
							блоков или других стройматериалов окончена, они покрываются специальными химическими
							составными для улучшения устойчивости к влаге и температурным перепадам.</p>
					</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title services-short-title">Установка блоков вентиляции и лифтовых шахт</div>
					<div class="info__text">
						<p>Использование вентиляционных блоков необходимо при строительстве естественной вытяжки в жилых
							домах и промышленных зданиях. Для определения необходимого количества блоков рассчитывается
							естественная вентиляция помещений.</p>
						<p>Для сборки объемных конструкций шахт лифтов используется сварка, которой соединяются
							закладные детали. Также предусмотрены специальные элементы для фиксации лифтовой кабины,
							дверей и противовеса.</p>
						<p>Шахта лифта состоит из:</p>
					</div>
					<ul class="info__list">
						<li>нижней блочной конструкции;</li>
						<li>блочных элементов первого этажа;</li>
						<li>основных этажных блоков;</li>
						<li>верхней блочной конструкции.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-17.webp">
					<div class="info__text">Клиенты могут заказать услуги строительно-монтажным работам в ООО «УМ-2020»
						в Минске, чтобы быть уверенными в своевременности и качестве выполнения работ.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-18.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Монтаж деревянных конструкций</div>
					<div class="info__text">Перед началом монтажа деревянных конструкций разрабатывается проектная
						документация с учётом количества необходимого материала. Монтажно-сборочные работы бывают двух
						видов:</div>
					<ul class="info__list">
						<li>Первый вариант подразумевает установку готовых конструкций, доставленных на место
							строительства.</li>
						<li>Во второй ситуации деревянные конструкции собираются отдельными элементами механическим
							путем.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-18.webp">
					<div class="info__text">На выбор подхода и стоимость влияет размер объекта и особенности
						строительной площадки.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Монтаж колонн</div>
					<div class="info__text">
						<p>Под колоннами подразумевается вертикальная конструкция, предназначенная для принятия
							нагрузки, которая широко используется в строительстве каркасов зданий.</p>
						<p>Монтажные работы в Республике Беларусь подразумевают:</p>
					</div>
					<ul class="info__list">
						<li>установку колонн;</li>
						<li>выверку установленных элементов;</li>
						<li>временный крепеж;</li>
						<li>демонтаж кондукторов и фиксаторов.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-19.webp">
					<div class="info__text">Чтобы монтировать большие колонны кроме опыта и навыков потребуется
						спецтехника, которая есть в автопарке ООО «УМ-2020».</div>
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-20.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Монтаж стен подземной части здания</div>
					<div class="info__text">
						<p>Подземная часть любого строения находится ниже перекрытия первых этажей. Обычно это фундамент
							и стены подвального или цокольного помещения, подземная парковка, убежище, пешеходный
							туннель и другие объекты.</p>
						<p>Монтаж стен подземной части здания подразумевает следующие особенности:</p>
					</div>
					<ul class="info__list">
						<li>Услуги монтажных работ подземной части здания начинаются с проверки качества поверхности
							внешних блоков.</li>
						<li>Подготовленные фундаментные блоки устанавливаются в котлован.</li>
						<li>Проверяется плотность примыкания основания к подошве.</li>
						<li>Швы заполняются песочно-цементным составом.</li>
						<li>Проверяются отклонения, и заполняются швы.</li>
						<li>Выполняется обратная засыпка грунта.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-20.webp">
					<div class="info__text">Установка подземной части стен требует ответственного подхода, который
						обеспечивают профессионалы ООО «УМ-2020».</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Установка ригелей при возведении многоэтажных построек</div>
					<div class="info__text">
						<p>Под ригелем подразумевают железобетонный элемент, на который укладывают перекрытие во время
							строительства многоэтажных построек. Это необходимо для качественного соединения
							вертикальных несущих стен.</p>
						<p>Монтаж ригеля подразумевает:</p>
					</div>
					<ul class="info__list">
						<li>монтаж колонны в запланированном положении;</li>
						<li>укладку ригелей;</li>
						<li>выверку установленных элементов;</li>
						<li>сварку металлических закладных и консолей колонн.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-21.webp">
					<div class="info__text">Качественно установленные ригели выдерживают разнонаправленные нагрузки.
					</div>
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-22.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Монтаж легких ограждающих конструкций</div>
					<div class="info__text">Лёгкая ограждающая конструкция необходима для разграничения внутреннего
						пространства во время ремонта. Преимущество использования таких элементов кроется в их:</div>
					<ul class="info__list">
						<li>долговечности;</li>
						<li>прочности;</li>
						<li>пожаробезопасности;</li>
						<li>удобной сборке;</li>
						<li>отсутствии усадки.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-22.webp">
					<div class="info__text">Услуги по строительно-монтажным работам требуют точности и аккуратности,
						которыми обладают профессионалы ООО «УМ-2020».</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
			<div class="services-page__item">
				<div class="services-page__info">
					<div class="info__title">Гипсобетонные перегородки</div>
					<div class="info__text">Панели из гипса и бетона активно используют, когда, сооружаются межкомнатные
						и межквартирные перегородки. Они подходят для возведения стен, а также чернового пола. Они
						устанавливаются после окончания строительства здания и монтажа прогонов перекрытия.
						Использование таких перегородок намного выгоднее в финансовом плане по сравнению с кирпичными,
						железобетонными и деревянными аналогами.</div><img class="service-page__image-mobile"
						alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-23.webp">
					<div class="info__call-button">Подробнее</div>
				</div>
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
			...
			<div class="services-page__item">
				<div class="services-page__image">
					<div class="helper"></div><img alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-24.webp">
				</div>
				<div class="services-page__info">
					<div class="info__title">Особенности каркасно-обшивных перегородок</div>
					<div class="info__text">
						<p>С помощью каркасно-обшивных перегородок разделяют общую площадь квартиры или частного дома.
							Конструктивно такие элементы бывают пустотелыми или с наполнителем для улучшения звуковой и
							тепловой изоляции.</p>
						<p>Для изготовления таких перегородок используется:</p>
					</div>
					<ul class="info__list">
						<li>обрезная деревянная доска или брус;</li>
						<li>профили из стали.</li>
					</ul>
					<div class="info__text">Для изготовления стен используется:</div>
					<ul class="info__list">
						<li>доска;</li>
						<li>плитный материал.</li>
					</ul><img class="service-page__image-mobile" alt="service-img"
						src="<?php echo get_template_directory_uri(); ?>/assets/images/service-banner-img-24.webp">
					<div class="info__text">Качественная звукоизоляция обеспечивается заполнением пустот специальным
						материалом, поглощающим звук.</div>
					<div class="info__call-button">Подробнее</div>
				</div>
			</div>
		</div>
	...
	<div class="info construction-services-info">
		<div class="container">
			<div class="info__full">
				<div class="info__title">Почему стоит доверять ООО «УМ-2020»</div>
				<div class="info__text">
					<p>Нами выполняются любые монтажные работы в соответствии с особенностями строительного объекта и
						пожеланий заказчика.</p>
					<p>Сотрудничество с нами подразумевает ряд преимуществ для клиентов:</p>
				</div>
				<ul class="info__list">
					<li>использование проверенных технологий и качественных стройматериалов;</li>
					<li>контроль всех строительных этапов;</li>
					<li>выполнение работ в сроки, прописанные в договоре.</li>
				</ul>
				<div class="info__text">Чтобы заказать услуги монтажных работ, от профессионалов своего дела, достаточно
					связаться с нашими менеджерами любым удобным способом, предусмотренным на сайте.</div>
			</div>
		</div>
	</div>
